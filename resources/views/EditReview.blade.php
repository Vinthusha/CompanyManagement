        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="user-card shadow-sm grow bg-white p-4 text-center ctm-border-radius card">
                            <div class="user-info">
                                ...
                                <div class="user-details">
                                    <h4><b>Welcome Vinthusha</b></h4>
                                    <span class="ctm-text-sm">vinthushalogan@gmail.com</span>
                                </div>
                            </div>
                        </div>
                        <!-- Sidebar -->
                ...
                <div class="col-xl-9 col-lg-8  col-md-12">
                    <div class="quicklink-sidebar-menu ctm-border-radius shadow-sm grow bg-white p-4 mb-4 card grow">
                        <ul class="list-group list-group-horizontal-lg">

                            <li class="list-group-item text-center active button-5"><a href="profile-reviews.html" class="text-white">Reviews</a></li>
