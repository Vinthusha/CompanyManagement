...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="http://dreamguys.co.in/demo/dleohr/template-1/dleohr-vertical/assets/img/favicon.png">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="http://dreamguys.co.in/demo/dleohr/template-1/dleohr-vertical/assets/css/bootstrap.min.css">

    <!-- Linearicon Font -->
    <link rel="stylesheet" href="view-source:http://dreamguys.co.in/demo/dleohr/template-1/dleohr-vertical/index.html">

    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="http://dreamguys.co.in/demo/dleohr/template-1/dleohr-vertical/assets/css/font-awesome.min.css">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="http://dreamguys.co.in/demo/dleohr/template-1/dleohr-vertical/assets/css/style.css">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <h2><a href="employment.html">Vinthusha</a></h2>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <h2><a href="employment.html"> Pethurushan</a></h2>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown action-label drop-active">
                                                            <a href="javascript:void(0)" class="btn btn-white btn-sm dropdown-toggle" data-toggle="dropdown"> Active <i class="caret"></i></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <h2><a href="employment.html">Mathunujan</a></h2>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown action-label drop-active">
                                                            <a href="javascript:void(0)" class="btn btn-white btn-sm dropdown-toggle" data-toggle="dropdown"> Active <i class="caret"></i></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <h2><a href="employment.html"> Logitha</a></h2>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown action-label drop-active">
                                                            <a href="javascript:void(0)" class="btn btn-white btn-sm dropdown-toggle" data-toggle="dropdown"> Active <i class="caret"></i></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <h2><a href="employment.html"> Thanojika</a></h2>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown action-label drop-active">
                                                            <a href="javascript:void(0)" class="btn btn-white btn-sm dropdown-toggle" data-toggle="dropdown"> Active <i class="caret"></i></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <h2><a href="employment.html"> Anchayan</a></h2>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown action-label drop-active">
                                                            <a href="javascript:void(0)" class="btn btn-white btn-sm dropdown-toggle" data-toggle="dropdown"> Active <i class="caret"></i></a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <h2><a href="employment.html">Nixchala</a></h2>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown action-label drop-active">
                                                            <a href="javascript:void(0)" class="btn btn-white btn-sm dropdown-toggle" data-toggle="dropdown"> Active <i class="caret"></i></a>
...
<script src="view-source:http://dreamguys.co.in/demo/dleohr/template-1/dleohr-vertical/company.html"></script>

<script src="http://dreamguys.co.in/demo/dleohr/template-1/dleohr-vertical/assets/plugins/select2/moment.min.js"></script>

<script src="http://dreamguys.co.in/demo/dleohr/template-1/dleohr-vertical/assets/js/bootstrap-datetimepicker.min.js"></script>
